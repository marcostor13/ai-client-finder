  ...
  return (
    <div className="coach-page">
      <div className="coach-head">
        <div>
          <h1>
            <Trophy size={26} style={{ color: "#a78bfa" }} /> Coach Personal
          </h1>
          <p className="coach-sub">
            Tu agente enfocado 100% en tu Plan Integral y Financiero. Te
            acompaña por Telegram, te recuerda tus prioridades, mide tu avance y
            te mantiene en el camino sin perder el contexto.
          </p>
          <div
            style={{
              display: "flex",
      ...
      {!enabled ? (
        <div className="coach-card" style={{ marginTop: 28 }}>
          <div className="coach-empty">
            <Trophy
              size={40}
              style={{ color: "rgba(167,139,250,0.4)", marginBottom: 14 }}
            />
            <p
              style={{
                fontSize: "1rem",
            ...
            <p>
              Actívalo para cargar tus metas del plan, recibir mensajes
              proactivos por Telegram y ver tu dashboard de avances.
            </p>
            <button
        ...
        <>
          ...
          {tab === "goals" && <CoachGoals onChange={loadMetrics} />}
          {tab === "referentes" && <CoachReferentes />}
          {tab === "schedule" && <CoachSchedule tgConnected={tgConnected} />}
          {tab === "logs" && <CoachLogs />}
        </>
      )}
    </div>
