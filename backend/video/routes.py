...
async def upload_video(
    ...
    if images_enabled and not (settings.pexels_api_key or settings.pixabay_api_key):
        raise HTTPException(
            400,
            "B-roll activado pero no hay proveedor de stock configurado. "
            "Agrega PEXELS_API_KEY y/o PIXABAY_API_KEY al .env para intercalar "
